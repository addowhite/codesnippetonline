		...
		<div class="header-container">
			...
			<div class="button-container">
				<?=Infra::check_user_logged_in()
					? button("button-create-account", "New post", "/pages/edit_post/edit_post.php") . button("button-logout", "Sign out", "/processes/logout_user.php")
	...
	<div class="scrollable-content-pane">
		...
		<div class="page page-footer">
			<div class="footer-container">
				Code Snippet Online © 2017 Adorjan White; Source under MIT License.
			</div>
		</div>
	</div>
</body>
